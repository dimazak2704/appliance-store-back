...
class OrdersTest {
    ...
    void checkParameterTypeForConstructorWithParameter() {
        ...
        parameters.stream()
                .filter(p -> p.toString().contains("java.util.Set<com.epam.dimazak.appliances.model.OrderRow>"))
                .findFirst()
                .orElseThrow(()->new RuntimeException("No parameter with type java.util.Set<com.epam.dimazak.appliances.model.OrderRow>"));
    }
